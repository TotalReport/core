...
import { ReportsListBlock } from "./reports-list-block.jsx";
...
const meta: Meta<typeof ReportsListBlock> = {
  title: "Containers/Reports/ReportsListBlock",
  component: ReportsListBlock,
  decorators: [
    (Story) => {
      queryClient.clear();
      return (
...
export default meta;
type Story = StoryObj<typeof ReportsListBlock>;
