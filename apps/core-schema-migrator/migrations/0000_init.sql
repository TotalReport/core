...
ALTER TABLE "after_tests" ADD CONSTRAINT "after_tests_test_context_id_test_contexts_id_fk" FOREIGN KEY ("test_context_id") REFERENCES "public"."test_contexts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "before_tests" ADD CONSTRAINT "before_tests_test_context_id_test_contexts_id_fk" FOREIGN KEY ("test_context_id") REFERENCES "public"."test_contexts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "test_contexts" ADD CONSTRAINT "test_contexts_launch_id_launches_id_fk" FOREIGN KEY ("launch_id") REFERENCES "public"."launches"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tests" ADD CONSTRAINT "tests_test_context_id_test_contexts_id_fk" FOREIGN KEY ("test_context_id") REFERENCES "public"."test_contexts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
